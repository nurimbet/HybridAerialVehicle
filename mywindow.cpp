...
void MyWindow::drawSkels()
{
    ...
    if (path_bool == 0 || path_bool > 1) {
        ...
        while (!edges.eof()) {
            edges >> x >> y >> z >> ign >> ign >> ign >> ign >> ign >> x1 >> y1 >> z1 >> ign >> ign >> ign >> ign >> ign;
            //std::cout << x << std::endl;
            glVertex3f(x, y, z);
            glVertex3f(x1, y1, z1);
        }
    ...
    if (path_bool >= 1) {
        ...
        fin_to >> x >> y >> z >> ign >> angz >> ign >> angx >> ign >> ign >> ign >> ign >> ign;
        glVertex3f(x, y, z + 10);
        while (!fin_to.eof()) {
            fin_to >> x >> y >> z >> ign >> angz >> ign >> angx >> ign >> ign >> ign >> ign >> ign;
        ...
        fin_c >> x >> y >> z >> ign >> angz >> ign >> angx >> ign >> ign >> ign >> ign >> ign;
        while (!fin_c.eof()) {
            fin_c >> x >> y >> z >> ign >> angz >> ign >> angx >> ign >> ign >> ign >> ign >> ign;
        ...
        fin_l >> x >> y >> z >> ign >> angz >> ign >> angx >> ign >> ign >> ign >> ign >> ign;
        while (!fin_l.eof()) {
            fin_l >> x >> y >> z >> ign >> angz >> ign >> angx >> ign >> ign >> ign >> ign >> ign;
